...
var boundsStream2 = {
  ...
  polygonEnd: function() {
    ...
    if (areaRingSum2 < 0) lambda02 = -(lambda1 = 180), phi0 = -(phi1 = 90);
...
function centroid_default2(object2) {
  ...
  if (m < epsilon2) {
    x = X12, y = Y12, z = Z12;
    if (W1 < epsilon) x = X02, y = Y02, z = Z02;
    m = hypot(x, y, z);
...
export {
  bounds_default2 as bounds_default,
  distance_default,
  contains_default,
  graticule,
  interpolate_default,
...
//# sourceMappingURL=chunk-SM7XIKV3.js.map
